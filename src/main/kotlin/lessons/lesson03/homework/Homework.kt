...
//36. Индикатор доступности специализированного оборудования в данный момент (например, специальному оборудованию) - логический тип, информация получается в моменте, публичная (спорно, но оставлю так)
lateinit var accessibilityStatus: String //сменила Boolean на String из-за ошибки с lateinit
...
private lateinit var averageMood: String //сменила Double на String из-за ошибки с lateinit
